        ...
        <div class="detail-page-body container">
            <div class="detail-data-wrapper">
                ...
                <div class="img-detail-news">
                    <img src="{{ asset('storage/' . $newsItem->cover_photo_path) }}" alt="{{ $newsItem->title }}">
                </div>
            ...
            <div class="post-section">
                <div class="post-wrapper owl-carousel owl-theme" id="ta_post">
                    @foreach ($otherPosts as $post)
                        <div class="post-item">
                            <div class="post-img">
                                <img src="{{ asset('storage/' . $post->cover_photo_path) }}" alt="{{ $post->title }}">
                            </div>
